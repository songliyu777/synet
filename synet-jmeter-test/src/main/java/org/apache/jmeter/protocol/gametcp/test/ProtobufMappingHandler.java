...
import org.apache.jmeter.protocol.gametcp.test.logic.LogicHandler;
...
public class ProtobufMappingHandler {
    ...
    public static void addHandler(Class<? extends LogicHandler> handlerClass) {
        PROTOBUF_ANNOTATIONS.add(handlerClass);
    }
