...
public class GameTcpClientTest implements TCPClient {
    ...
    {
        ProtobufMappingHandler.addHandler(GameLogicHandler.class);
        ProtobufMappingHandler protobufMappingHandler = new ProtobufMappingHandler();
        messageHandler = new MessageHandler(protobufMappingHandler);
    }
